...
const probePath = join(__dirname, "_probe-r45-personalize-ui.mjs");
...
describe.skipIf(!canLaunch)("R45 — Settings 个性化 UI 简化探针", () => {
  it("R45 真机断言全绿(ThemePicker 可见 + ThemeStudio 始终可见 + 旧 toggle 移除 + 字号独立)", () => {
