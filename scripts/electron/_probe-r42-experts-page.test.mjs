...
const probePath = join(__dirname, "_probe-r42-experts-page.mjs");
...
describe.skipIf(!canLaunch)("R42 — 专家页完全复刻 WorkBuddy v5.4.7 探针", () => {
  it("R42 真机断言全绿(左侧任务栏 + 右侧主区 + 综合/最新 + 4 列网格)", () => {
