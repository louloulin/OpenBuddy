/**
 * _probe-r42-experts-page.test.mjs — R42 探针的 vitest 包装。
 *
 * 探针本身是 top-level 脚本,这里 spawn 它并断言 stdout 里 JSON 的 steps[] 全绿。
 *
 * 跑法:npx vitest run scripts/electron/_probe-r42-experts-page.test.mjs
 */
...
const probePath = join(__dirname, "_probe-r44-theme-picker-custom.mjs");
...
describe.skipIf(!canLaunch)("R44 — ThemePicker 自定义主题闭环探针", () => {
  it("R44 真机断言全绿(custom 主题出现在 picker + 点击应用 vars + 持久化 active + Studio 事件实时刷新)", () => {
