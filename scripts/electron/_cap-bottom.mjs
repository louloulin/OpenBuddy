...
const userData = mkdtempSync(join(tmpdir(), "ob-c-"));
...
const m = await page.evaluate(() => {
  ...
  return {
    ...
    checklist: b('.onboarding-checklist'),
    practice1: b('.home__practice-card:nth-child(1)'),
    practice5: b('.home__practice-card:nth-child(5)'),
    lastCard: b('.home__practice-card:last-child'),
  };
});
