/**
 * _probe-r54-theme-import.test.mjs — R54 探针的 vitest 包装。
 */
...
const probePath = join(__dirname, "_probe-r54-theme-import.mjs");
...
describe.skipIf(!canLaunch)("R54 — ThemeStudio JSON 导入真机探针", () => {
  it("设置 → 个性化 → ThemeStudio → 导入 JSON:bad 给错误提示,good 覆盖 label/type/滑块", () => {
