...
|---|---|---|
| [**GitHub Discussions**](https://github.com/louloulin/OpenBuddy/discussions) | Async threaded conversations | Design questions, "how do I…", show & tell |
| [**GitHub Issues**](https://github.com/louloulin/OpenBuddy/issues) | Bug reports & feature requests | Reproducible bugs, concrete proposals |
| [**Discord**](https://discord.gg/openbuddy) | Real-time chat | Quick questions, casual conversation, collaboration |
...
| **Twitter / X** [@openbuddy](https://twitter.com/openbuddy) | Release announcements | Following the project |
...
Want to start a new language channel? See [`../CONTRIBUTING.md`](../CONTRIBUTING.md#i18n) for the localization workflow, then ping a moderator.
...
All channels are governed by [`../CODE_OF_CONDUCT.md`](../CODE_OF_CONDUCT.md). Violations may be reported to `conduct@openbuddy.dev` or via Discord DM to any moderator.
...
- 🕘 Every **Wednesday 14:00 UTC** (22:00 CST, 23:00 JST)
- 📍 Where: [Discord Stage Channel `#office-hours`](https://discord.gg/openbuddy)
- 📝 Agenda: top-voted GitHub Discussions + ad-hoc questions

Recordings are posted to the [OpenBuddy YouTube channel](https://youtube.com/@openbuddy) within 24h.
...
- **[Casdoor](https://casdoor.org/)** — OIDC IdP
- **[NewAPI](https://github.com/songquanpeng/new-api)** — model gateway
...
| 频道 | 用途 | 适合 |
|---|---|---|
| [**GitHub Discussions**](https://github.com/louloulin/OpenBuddy/discussions) | 异步串行讨论 | 设计问题、"怎么做…"、Show & Tell |
| [**GitHub Issues**](https://github.com/louloulin/OpenBuddy/issues) | Bug 报告 & 功能请求 | 可复现的 Bug、具体提案 |
| [**Discord**](https://discord.gg/openbuddy) | 实时聊天 | 快问快答、轻度交流、协作 |
| **Office Hours**(每周) | 与维护者视频 Q&A | 深度话题、路线图问题、带教 |
| **微信群** | 中文聊天 | 中文用户即时交流 |
| **Twitter / X** [@openbuddy](https://twitter.com/openbuddy) | 发布公告 | 跟进项目动态 |
...
想开一门新语言的频道?见 [`../CONTRIBUTING.md`](../CONTRIBUTING.md#i18n) 的本地化工作流,然后 ping 任意 Moderator。
...
所有频道由 [`../CODE_OF_CONDUCT.md`](../CODE_OF_CONDUCT.md) 约束。违规可举报至 `conduct@openbuddy.dev`,或在 Discord 私信任意 Moderator。
...
- 📍 地点:[Discord Stage 频道 `#office-hours`](https://discord.gg/openbuddy)
- 📝 议程:GitHub Discussions 投票最高的话题 + 临时提问

录像 24h 内发布到 [OpenBuddy YouTube 频道](https://youtube.com/@openbuddy)。
...
- **[Casdoor](https://casdoor.org/)** —— OIDC IdP
- **[NewAPI](https://github.com/songquanpeng/new-api)** —— 模型网关
- **[moonrepo](https://moonrepo.dev)** —— monorepo 工具
- **[Electron](https://www.electronjs.org/)** —— 桌面 Shell
...
<sub>本页每周更新。如果链接失效或需要更新,开 [Issue 标签 `community`](https://github.com/louloulin/OpenBuddy/issues/new?labels=community)。</sub>
