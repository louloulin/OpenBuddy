...
const workspacePackageAliases: Array<{ find: string; replacement: string }> = [
  ...
  { find: "@openbuddy/plugin-host/plugin-manifest", replacement: resolve(__dirname, "packages/runtime/openbuddy-plugin-host/src/openbuddy-plugin-manifest.ts") },
  ...
  { find: "@openbuddy/dsh-core/state", replacement: resolve(__dirname, "packages/runtime/openbuddy-dsh-core/src/state.ts") },
  { find: "@openbuddy/dsh-core/goals", replacement: resolve(__dirname, "packages/runtime/openbuddy-dsh-core/src/goals.ts") },
  { find: "@openbuddy/dsh-core/message-feedback", replacement: resolve(__dirname, "packages/runtime/openbuddy-dsh-core/src/message-feedback.ts") },
  ...
  { find: "@openbuddy/plugin-sdk", replacement: resolve(__dirname, "packages/runtime/openbuddy-plugin-sdk/src/index.ts") },
