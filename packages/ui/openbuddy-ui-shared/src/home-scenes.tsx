 ...
 *
 * 与 WorkBuddy 的差异:
 *   - OpenBuddy 把 Skill 开发 / Agent 应用 放在「代码开发」场景下;
 *     WorkBuddy 把个人工作台 / 幻灯片放在「日常办公」场景下。
 *   - 这里采用 OpenBuddy 的分组,但保证「日常办公」场景下也有 7 个完整 chip
 *     与 WorkBuddy 一致,通过新增 个人工作台 / 幻灯片 两个 category 凑齐。
 */
 ...
 *  WorkBuddy 默认把 working 场景下的全部 7 个 chip 都展示,
 *  这里把阈值设为 7,与 WorkBuddy 保持一致。 */
export const COLLAPSED_VISIBLE_COUNT = 7;
    ...
    categories: [
      {
        ...
        templates: [
          ...
          },
          {
            title: "结构化周报",
            prompt:
              "请根据本周的工作记录帮我生成一份结构化周报:本周完成、下周计划、关键数据与风险事项。",
            gradient: "linear-gradient(135deg, #6366f1 0%, #8b5cf6 100%)",
            glyph: <FileSpreadsheet size={48} strokeWidth={1.5} />,
          },
        ],
      },
      {
        ...
        templates: [
          {
            title: "今日待办规划",
            prompt:
              "请根据我今天的目标与未完成任务,帮我规划一份今日待办清单,按优先级与时间块组织。",
          },
          {
            title: "周复盘",
            prompt:
              "请帮我做一份周复盘:总结本周完成、产出、未完成与下周计划,并指出可改进项。",
          },
        ],
      },
      {
        ...
        templates: [
          {
            title: "产品介绍 Slides",
            prompt:
              "请帮我做一份 10 页的产品介绍幻灯片,包括目标用户、核心功能、差异化卖点与下一步规划。",
          },
          {
            title: "季度汇报",
            prompt:
              "请帮我整理一份季度汇报幻灯片大纲:包含业绩、关键项目、挑战与下季度目标。",
          },
        ],
      },
      {
