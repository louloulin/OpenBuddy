...
- **命名**: `@openbuddy/ui-settings-models`,目录 `packages/ui/openbuddy-ui-settings-models/`
...
- `@openbuddy/ui-settings-models/client` — 槽位注册入口,由 `@openbuddy/ui-runtime` 调用
- `@openbuddy/ui-settings-models/invariant` — 不变式同伴(开发态类型守卫)
