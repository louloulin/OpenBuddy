 ...
 *  5. 输入 prompt → 在新会话中运行（接 piNewSession + piSend）
 *
...
import {
  ...
  SparklesIcon,
  CheckIcon,
  RefreshCwIcon, WarningOutlineIcon } from "@openbuddy/ui-primitives/icons";
import {
  agentsList,
  mcpList,
  skillsList,
} from "@/lib/agent/pi-client";
import type { AgentEntry, McpServerEntry, SkillInfo } from "@openbuddy/shared-types";
