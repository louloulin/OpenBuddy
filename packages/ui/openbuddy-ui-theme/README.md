...
- **命名**: `@openbuddy/ui-theme`,目录 `packages/ui/openbuddy-ui-theme/`
...
- `@openbuddy/ui-theme/client` — 槽位注册入口,由 `@openbuddy/ui-runtime` 调用
- `@openbuddy/ui-theme/invariant` — 不变式同伴(开发态类型守卫)
