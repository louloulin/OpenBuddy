...
import {
  ...
  type StreamingState,
  type StreamAction,
} from "@openbuddy/agent-rpc/stream/streaming-message";
import { IDLE_PHASE, phaseReducer, type AgentPhase, type AgentPhaseEvent } from "@openbuddy/agent-rpc/stream/agent-phase";
