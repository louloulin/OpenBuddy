...
- **命名**: `@openbuddy/ui-slots`,目录 `packages/ui/openbuddy-ui-slots/`
...
- `@openbuddy/ui-slots/client` — 槽位注册入口,由 `@openbuddy/ui-runtime` 调用
- `@openbuddy/ui-slots/invariant` — 不变式同伴(开发态类型守卫)
