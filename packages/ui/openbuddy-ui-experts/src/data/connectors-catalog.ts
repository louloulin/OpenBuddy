import type { ConnectorCatalogItem } from "@openbuddy/shared-types";
...
export const CONNECTOR_LIST: ConnectorCatalogItem[] = [
  ...
  { id: "gmail", name: "Gmail / Google Workspace", color: "#ea4335",
    desc: "连接 Gmail 或 Google Workspace，支持统一收件箱、线程搜索、标签、草稿、附件和安全发送。需要通过已授权的 Gmail MCP 或 API connector 接入。" },
  { id: "outlook", name: "Outlook / Microsoft 365", color: "#0078d4",
    desc: "连接 Outlook 或 Microsoft 365，支持邮件、文件夹、附件和后续日历/任务联动。需要通过已授权的 Microsoft Graph MCP 或 connector 接入。" },
  { id: "imap-smtp", name: "IMAP / SMTP 邮箱", color: "#64748b",
    desc: "兼容企业私有域、163、126、Yahoo、Fastmail 等标准邮箱。凭据应由 connector 使用系统密钥链保存，OpenBuddy 不记录密码。" },
