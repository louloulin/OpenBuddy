 ...
 * and the chat session title markup.
 *
 ...
 * production empty-state and title blocks use. The production markup
 * in ChatView.tsx is kept in lockstep with the markup below; this
 * catches regressions in either the component or the matching CSS
 * hooks.
 */
function EmptyState() {
  return (
