...
- **命名**: `@openbuddy/ui-locale`,目录 `packages/ui/openbuddy-ui-locale/`
...
- `@openbuddy/ui-locale/client` — 槽位注册入口,由 `@openbuddy/ui-runtime` 调用
- `@openbuddy/ui-locale/invariant` — 不变式同伴(开发态类型守卫)
