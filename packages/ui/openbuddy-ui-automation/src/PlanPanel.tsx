/**
 * 计划面板 — 显示 pi 的 ACP Plan（任务列表）+ 审批/编辑/执行控制。
 *
 * 增强点（对齐 WorkBuddy）：
...
import { togglePlanMode } from "@/lib/agent/pi-client";
import type { PlanEntry, PlanEntryPriority, PlanEntryStatus } from "@openbuddy/shared-types";
import {
  reorderPlan,
  addPlanEntry,
  cycleEntryStatus,
} from "@/lib/ui/plan-utils";
import {
  CheckIcon,
  ClockIcon,
  LoaderIcon,
